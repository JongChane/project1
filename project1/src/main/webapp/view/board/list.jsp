...
<table>
	...
	<c:if test="${boardcount > 0}">
		...
		<button onclick="filterByCategory('')">전체</button>
		<button onclick="filterByCategory('1')">유머</button>
		<button onclick="filterByCategory('2')">썰</button>
		<button onclick="filterByCategory('3')">공포</button>
		<button onclick="filterByCategory('4')">감동</button>
		</tr>
		<tr>
			<th width="5%">글번호</th>
			<th width="10%">분류</th>
