...
<div class="container">
   <div>
      <div class="category">베스트게시판</div>
      <c:forEach items="${best}" var="board" varStatus="status">
         <c:if test="${status.index < 5}">
            <div class="board">
               <a href="../board/info?board_num=${board.board_num}">${board.content}</a> - 
                        <c:choose>
